...
namespace NiumaTPC.Character
{
    ...
    public class NiumaCharacterController : MonoBehaviour, IDamageable, IPoolable
    {
        ...
        public void OnDespawned()
        {
            ...
            AnimationFacade?.ClearOnEndCallback(0);
            AnimationFacade?.ClearOnEndCallback(1);
            AnimationFacade?.ClearOnEndCallback(2);
        ...
        {
            if (AnimationFacade != null && Config != null)
            {
                AnimationFacade.SetLayerMask(1, Config.Core.UpperBodyMask);
                AnimationFacade.SetLayerMask(2, Config.Core.FacialMask);
            }
        }
